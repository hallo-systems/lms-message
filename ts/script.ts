const chapters = {
    ...
    "Chapter3":"繰り返し","Chapter4":"繰り返し","Chapter8":"繰り返し","Chapter9":"繰り返し",
...
let todayLessonType = "";
let typingType = "";
function displayHandler(lessonType: string) {
    todayLessonType = lessonType;
    if (lessonType == "normal") {
        (document.getElementById("normalDay") as HTMLStyleElement).style.display = "inline";
        (document.getElementById("presentationDay") as HTMLStyleElement).style.display = "none";
    } else if(lessonType == "presentation") {
        (document.getElementById("presentationDay") as HTMLStyleElement).style.display = "inline";
        (document.getElementById("normalDay") as HTMLStyleElement).style.display = "none";
    }
}

let message = "";
function submitHandler() {
    const chapter = (document.getElementById("chapter") as HTMLSelectElement).value;
